...
use App\Http\Controllers\Media2Controller;
...
Route::group(['middleware' => 'prevent-back-button'],function(){
    Route::get('/',[FrontController::class,'home'])->name('home');
     Route::get('/our-communities',[FrontController::class,'Communities'])->name('Communities');
  ...
  /*  Route::get('cart', [CartController::class, 'cart'])->name('cart');
    ...
    Route::get('/delete-achivement-image',[AchivementController::class,'deletePageImage'])->name('delete-achivement-image');


    Route::get('/add-gallerycategory',[GalleryCategoryController::class,'addGallerycategory'])->name('add-gallerycategory');
    Route::post('/store-gallerycategory',[GalleryCategoryController::class,'storeGallerycategory'])->name('store-gallerycategory');
    Route::get('/all-gallerycategory',[GalleryCategoryController::class,'allGallerycategory'])->name('all-gallerycategory');
    Route::get('/edit-gallerycategory',[GalleryCategoryController::class,'editGallerycategory'])->name('edit-gallerycategory');
    Route::post('/update-gallerycategory',[GalleryCategoryController::class,'updateGallerycategory'])->name('update-gallerycategory');
    Route::get('/delete-gallerycategory',[GalleryCategoryController::class,'deleteGallerycategory'])->name('delete-gallerycategory');
    Route::get('/change-gallerycategory-status',[GalleryCategoryController::class,'changeaGallerycategoryStatus'])->name('change-gallerycategory-status');


     Route::get('/add-media2',[Media2Controller::class,'addMedia'])->name('add-media2');
    
    Route::post('/store-media2',[Media2Controller::class,'storeMedia'])->name('store-media2');
    Route::get('/all-media2',[Media2Controller::class,'allMedia'])->name('all-media2');
    Route::get('/edit-media2',[Media2Controller::class,'editMedia'])->name('edit-media2');
    Route::post('/update-media2',[Media2Controller::class,'updateMedia'])->name('update-media2');
    Route::get('/delete-media2',[Media2Controller::class,'deleteMedia'])->name('delete-media2');
    Route::get('/change-media-status2',[Media2Controller::class,'changeaMediaStatus'])->name('change-media-status2');
    ...
    Route::get('/gallery-details',[EventsController::class,'gallery_details'])->name('gallery-details');
