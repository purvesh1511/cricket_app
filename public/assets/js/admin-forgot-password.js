function renderSendEmailForm(token) {
    ...
    $.ajax({
        url: "admin-render-send-email-form",
        type: "POST",
        data: {
            _token: token,
        },
...
function renderVerificationForm(token) {
    $.ajax({
        url: "admin-render-verification-form",
        type: "POST",
        data: {
            _token: token,
        },
...
function sendVerificationMail(event, token) {
    ...
    $("#loginFormWrap").html('<span class="loader mx-auto"></span>');
    $.ajax({
        url: "admin-send-verification-mail",
        processData: false,
        contentType: false,
        type: "POST",
...
function renderResetPasswordForm(token) {
    $.ajax({
        url: "admin-render-reset-password-form",
        type: "POST",
        data: {
            _token: token,
        },
