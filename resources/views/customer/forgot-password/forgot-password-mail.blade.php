...
<body class="clean-body u_body"
    ...
    <table id="u_body"
        style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: #f3f6f6;width:100%"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 0px 20px;font-family:arial,helvetica,sans-serif;"
                                                            align="left">

                                                            <div class="v-text-align"
                                                                style="font-size: 14px; line-height: 160%; text-align: left; word-wrap: break-word;">
                                                                <p style="line-height: 160%;">
                                                                    <strong>Hello {{ $fname }}</strong>, It is an
                                                                    auto generated mail regards your recent
                                                                    password reset request. We initiated your account
                                                                    password regeneration. Below notice the <strong>6
                                                                        Digit Confirmation Code</strong>. Copy the code
                                                                    and use to reset password.
                                                                </p>
                                                            </div>
                            ...
                            <div
                                ...
                                <div id="u_column_6" class="u-col u-col-100"
                                    ...
                                    <div
                                        ...
                                        <!--[if (!mso)&(!IE)]><!-->
                                        <div class="v-col-border"
                                            style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 30px solid #ffffff;border-left: 30px solid #ffffff;border-right: 30px solid #ffffff;border-bottom: 30px solid #ffffff;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                            <!--<![endif]-->
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align"
                                                                style="font-size: 30px; line-height: 160%; text-align: center; word-wrap: break-word;">
                                                                <p style="line-height: 160%;"><span
                                                                        style="color: #2dc26b; line-height: 22.4px;"><strong>{{ $code }}</strong></span>
                                                                </p>
                                                            </div>
