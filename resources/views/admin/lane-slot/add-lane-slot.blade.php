        ...
        <div class="container-fluid">
            <div class="card bg-light-info shadow-none position-relative overflow-hidden">
                <div class="card-body px-4 py-3">
                    <div class="row align-items-center">
                        <div class="col-12">
                            <h4 class="fw-semibold mb-8">MANAGE LANE SLOT</h4>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-muted text-decoration-none"
                                            href="{{ route('all-achivement') }}">Lane Slot</a>
                                    </li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <!-- <div class="card">
                        <div class="card-body"> -->
                            <form action="{{ route('store-lane-slot') }}" method="POST" onsubmit="addPage(event,this)"
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select name="day"  class="form-control" required>
                                        ...
                                        @php 
                                          $disbled="";
                                          $DayExists=DB::table('lane_slot')->where('day',$day->day_name)->exists(); 
                                          if($DayExists){
                                            $disbled="disabled";
                                          }
                                        @endphp
                                        <option value="{{$day->day_name}}" {{$disbled}}> {{$day->day_name}}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$slot->slot_name}} <input type="hidden" name="slot_{{$slot->id}}" value="{{$slot->id}}"></td>
                                                        ...
                                                        <td  style="text-align:center"><input type="checkbox" value="{{$lane->id}}" name="lane_{{$lane->id}}_{{$slot->id}}" checked> </td> 
                                                        @endforeach
                                                        @endif
