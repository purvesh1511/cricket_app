        ...
        <div class="card bg-light-info shadow-none position-relative overflow-hidden">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-12">
                        <h4 class="fw-semibold mb-8">ALL MEDIA	</h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a class="text-muted "
                                        href="{{ route('dashboard') }}">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a class="text-muted " href="javascript:void(0)">Media</a>
                                </li>
                                <li class="breadcrumb-item" aria-current="page">All Media</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                ...
                                <table id="zero_config" class="table border table-striped table-bordered text-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($pages as $page)
											...
											<td>{{$page->id}}
                                                <td>
                                                    @if ($page->file_name != null || $page->file_name != '')
                                                        <img src="{{asset('page_image')}}/{{ $page->file_name }}"
                                                ...
                                                <td>
												<a  href="{{ route('edit-media2') }}?page_id={{ $page->id }}">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton"
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item d-flex align-items-center gap-3"
                                                                    href="{{ route('edit-media') }}?page_id={{ $page->id }}">
                                                    ...
                                                    <div class="modal-dialog modal-sm">
                                                        <div class="modal-content rounded-1">
                                                            <div class="modal-body message-body text-center p-4"
                                                                ...
                                                                <p>Are You Sure?</p>
                                                                <div class="mt-4">
                                                                    <a href="{{ route('change-media-status2') }}?page_id={{ $page->id }}"
                                                ...
                                                <div class="modal-dialog modal-sm">
                                                    <div class="modal-content rounded-1">
                                                        <div class="modal-body message-body text-center p-4"
                                                            ...
                                                            <p>Are You Sure?</p>
                                                            <div class="mt-4">
                                                                <a href="{{ route('delete-media2') }}?page_id={{ $page->id }}"
                                                                    class="btn btn-primary">Yes</a>
                                                                <button data-bs-dismiss="modal"
                                                                    class="btn btn-light border">No</button>
                                                            </div>
