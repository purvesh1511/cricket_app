        ...
        <div class="card bg-light-info shadow-none position-relative overflow-hidden">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-12">
                        <h4 class="fw-semibold mb-8">ALL NEWS</h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">All News</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($pages as $page)
											...
											<td>{{$page->id}}
                                                ...
                                                <td>
												<a href="{{ route('edit-achivement') }}?page_id={{ $page->id }}"><i class="fs-4 ti ti-edit"></i></a>
                                                    ...
                                                    <div class="modal-dialog modal-sm">
                                                        <div class="modal-content rounded-1">
                                                            <div class="modal-body message-body text-center p-4"
                                                                ...
                                                                <p>Are You Sure?</p>
                                                                <div class="mt-4">
                                                                    <a href="{{ route('change-achivement-status') }}?page_id={{ $page->id }}"
                                                ...
                                                <div class="modal-dialog modal-sm">
                                                    <div class="modal-content rounded-1">
                                                        <div class="modal-body message-body text-center p-4"
                                                            ...
                                                            <p>Are You Sure?</p>
                                                            <div class="mt-4">
                                                                <a href="{{ route('delete-achivement') }}?page_id={{ $page->id }}"
                                                                    class="btn btn-primary">Yes</a>
                                                                <button data-bs-dismiss="modal"
                                                                    class="btn btn-light border">No</button>
                                                            </div>
