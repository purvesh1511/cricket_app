                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach($orders as $order)
                                        ...
                                        <tr>
                                            ...
                                            <td class="mx-auto text-center">{{$order->event_date}}</td>
                                            <td class="mx-auto text-center">€{{$order->event_time}}</td>
                                            <td class="mx-auto text-center">€{{$order->event_address}}</td>
                                            <td class="mx-auto text-center">€{{$order->event_price}}</td>
                                        </tr>
                                    @endforeach
