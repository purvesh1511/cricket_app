                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($orders as $order)
                                                @php
                                                    ...
                                                    $slotDet   =DB::table('slot_master')->where('id',$order->slot_id)->first();
                                                    $laneDet   =DB::table('lane')->where('id',$order->lane_id)->first(); 
                                                ...
                                                <tr>
                                                    ...
                                                    <a href="{{route('accept-refund',['id'=>$order->orderid])}}" class="btn btn-primary"> Accept Refund </a>
                                                    <a href="{{route('reject-refund',['id'=>$order->orderid])}}" class="btn btn-primary"> Reject Payment </a>
                                                    @endif

                                                    

                                                    @if($order->status=='Accept Refund')
                                                    <a href="{{route('payment-refund',['id'=>$order->orderid])}}" class="btn success btn-primary"> Send Payment </a>
                                                    @endif
                                                    </td>
                                                    <!-- <td>
