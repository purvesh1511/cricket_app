                                    ...
                                    <table id="zero_config"
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($slots as $slot)
												...
												<td>
                                                    ...
                                                    <td>
                                                        @if ($slot->status == 1)
                                                            <button data-bs-toggle="modal"
                                                                data-bs-target="#changeStatus{{ $slot->id }}"
                                                    ...
                                                    <td>
                                                        <a class="dropdown-item d-flex align-items-center gap-3"
                                                            href="{{ route('edit-slot') }}?slot_id={{ $slot->id }}">
                                                ...
                                                @if ($slot->status == 1)
                                                    <div class="modal fade" id="changeStatus{{ $slot->id }}"
                                                        ...
                                                        <div class="modal-dialog modal-sm">
                                                            <div class="modal-content rounded-1">
                                                                <div class="modal-body message-body text-center p-4"
                                                                    ...
                                                                    <p>Are You Sure?</p>
                                                                    <div class="mt-4">
                                                                        <a href="{{ route('change-slot-status') }}?slot_id={{ $slot->id }}"
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content rounded-1">
                        <div class="modal-header">
                            <h5 class="mb-0 fs-5 p-1 text-danger">Add New Slot</h5>
                        </div>
                            ...
                            <div class="modal-body message-body p-4" data-simplebar="">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" autocomplete="off" placeholder="Slot Name" name="slot_name"
