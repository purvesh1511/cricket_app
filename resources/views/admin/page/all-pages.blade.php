        ...
        <div class="card bg-light-info shadow-none position-relative overflow-hidden">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-12">
                        <h4 class="fw-semibold mb-8">ALL PAGES</h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">All Pages</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($pages as $page)
											...
											<td>{{ $page->id }}</td>
                                                ...
                                                <td>{{ \Carbon\Carbon::parse($page->created_at)->format('d-m-Y') }}
                                                </td>
                                                <td>{{ \Carbon\Carbon::parse($page->updated_at)->format('d-m-Y h:i:s A') }}
                                                </td>
                                                <td>
                                                <a href="{{ route('edit-page') }}?page_id={{ $page->id }}">
                                                        ...
                                                        <a  href="/{{$page->slug}}" target="_blank" ><i class="fs-4 ti ti-eye"></i></a>
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton"
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item d-flex align-items-center gap-3"
                                                                    href="{{ route('edit-page') }}?page_id={{ $page->id }}">
                                                                    <i class="fs-4 ti ti-edit"></i>
                                                                    Edit
                                                                </a>
                                                            </li>
                                                    ...
                                                    <div class="modal-dialog modal-sm">
                                                        <div class="modal-content rounded-1">
                                                            <div class="modal-body message-body text-center p-4"
                                                                ...
                                                                <p>Are You Sure?</p>
                                                                <div class="mt-4">
                                                                    <a href="{{ route('change-page-status') }}?page_id={{ $page->id }}"
                                                ...
                                                <div class="modal-dialog modal-sm">
                                                    <div class="modal-content rounded-1">
                                                        <div class="modal-body message-body text-center p-4"
                                                            ...
                                                            <p>Are You Sure?</p>
                                                            <div class="mt-4">
                                                                <a href="{{ route('delete-page') }}?page_id={{ $page->id }}"
                                                                    class="btn btn-primary">Yes</a>
                                                                <button data-bs-dismiss="modal"
                                                                    class="btn btn-light border">No</button>
                                                            </div>
