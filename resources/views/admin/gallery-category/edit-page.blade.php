        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('update-gallerycategory') }}" method="POST" onsubmit="editAchivement(event,this)" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="number" name="sort_order" autocomplete="off" maxlength="5" class="form-control mb-3" value="{{ $page[0]->sort_order }}" required>
                                </div>  
