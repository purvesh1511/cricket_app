    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <!-- <div class="card">
                        <div class="card-body"> -->
                <form action="{{ route('store-gallerycategory') }}" method="POST" onsubmit="addPage(event,this)"
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="number" name="sort_order" maxlength="5" class="form-control" required>
                    </div>
