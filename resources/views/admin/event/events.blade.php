...
<div class="w-50 m-auto text-center" id="description">
...
<div class="container">
    ...
    echo $EventOrderCount=DB::table('event_order')->where('event_id',$events->event_id)->where('status','Complete')->where('status','Refund Pending')->count();
