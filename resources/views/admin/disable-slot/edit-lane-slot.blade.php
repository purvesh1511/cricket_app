        ...
        <div class="container-fluid">
            <div class="card bg-light-info shadow-none position-relative overflow-hidden">
                <div class="card-body px-4 py-3">
                    <div class="row align-items-center">
                        <div class="col-12">
                            <h4 class="fw-semibold mb-8">EDIT DISABLE LANE SLOT</h4>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('update-disable-slot') }}" method="POST" onsubmit="addPage(event,this)"
                                enctype="multipart/form-data">
                                @csrf
                                
                                <div class="col-md-12 mb-3">
                                <label>Date <span class="text-danger">*</span></label>
                                    <input type="date" name="day" id="day" readonly value="{{$single_slot[0]->date}}" class="form-control">
                                    <input type="hidden" name="hid_day" id="hid_day" value="{{$single_slot[0]->date}}">
                                </div>
                                ...
                                <div class="row" >
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        @if($slot_master)
                                            ...
                                            $day=$_GET['day'];
                                            $selLaneArr=[];
                                            $single_slot=DB::table('disable_lane_slot')->where('slot_id',$slot->id)->where('date',$day)->get();
