            ...
            <div class="card bg-light-info shadow-none position-relative overflow-hidden">
                <div class="card-body px-4 py-3">
                    <div class="row align-items-center">
                        <div class="col-9">
                            <h4 class="fw-semibold mb-8">COACH</h4>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a class="text-muted "
                                            href="{{ route('dashboard') }}">Home</a>
                                    </li>
                                    <li class="breadcrumb-item" aria-current="page">Coachs</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
												...
												<td>{{ $customer->id }}</td>
                                                    ...
                                                    <td>
                                                        <a class="dropdown-item d-flex align-items-center gap-3"
                                                            href="{{ route('edit-coachs') }}?customer_id={{ $customer->id }}">
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content rounded-1">
                        <div class="modal-header">
                            <h5 class="mb-0 fs-5 p-1 text-danger">Add New Coach</h5>
                        </div>
                        <form action="{{ route('store-coachs') }}" method="POST">
                            <div class="modal-body message-body p-4" data-simplebar="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <small> Phone</small>
                                        <input type="number" autocomplete="off" placeholder=" Phone" name="phone"
                                        class="form-control mb-2" required>
                                    </div>
                                    <div class="col-md-6">
